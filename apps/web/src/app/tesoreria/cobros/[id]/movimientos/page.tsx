...
export default function MovimientosCobroPage() {
  ...
  // Los movimientos/cobros parciales están en vencimiento.cobrosParciales
  const movimientos: CobroParcial[] = (vencimiento as any)?.cobrosParciales || []
                ...
                {movimientos.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="px-4 py-12 text-center text-muted-foreground">
                      ...
                      <p className="text-xs mt-1">Los cobros se registraran aqui</p>
                    </td>
                  </tr>
                ) : (
                  movimientos.map((mov, index) => (
                    <tr key={index} className="hover:bg-muted/30">
                      ...
                      <td className="px-4 py-3">
                        <Badge variant="outline" className="bg-green-50 text-green-700">Cobro</Badge>
                      </td>
