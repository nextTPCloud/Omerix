...
import { ArrowLeft, CreditCard, Edit, RefreshCw, CheckCircle2, Clock, AlertTriangle, XCircle, DollarSign } from 'lucide-react'
      ...
      <div className="w-full space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => router.push(`/tesoreria/pagos/${id}/editar`)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="p-6">
            <h3 className="font-semibold mb-4">Informacion del Proveedor</h3>
          ...
          <Card className="p-6">
            <h3 className="font-semibold mb-4">Informacion del Pago</h3>
            <div className="space-y-3">
              <div>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-red-600">{formatCurrency(vencimiento.importePendiente)}</p>
              </div>
              <div>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-2">
              <Button
                className="w-full"
                variant="outline"
                onClick={() => router.push(`/tesoreria/pagos/${id}/movimientos`)}
              >
                Ver movimientos
              </Button>
              {vencimiento.documentoId && (
                <Button
                  className="w-full"
                  variant="outline"
                  onClick={() => router.push(`/compras/facturas/${vencimiento.documentoId}`)}
                >
