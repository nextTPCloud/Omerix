...
import { ArrowLeft, Save, SlidersHorizontal, Search, X, FolderTree, Package } from 'lucide-react'
...
export default function NuevoModificadorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await modificadoresService.create(dataToSend)
      if (response.success) {
        toast.success('Modificador creado correctamente')
