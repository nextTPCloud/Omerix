...
import { FirmaInternaModal } from '@/components/firmas/FirmaInternaModal'
...
export default function ParteTrabajoDetallePage() {
  ...
  const [firmaInternaDialogOpen, setFirmaInternaDialogOpen] = useState(false)
  ...
  return (
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuLabel className="text-xs">Firma</DropdownMenuLabel>
                <DropdownMenuItem onClick={() => setFirmaDialogOpen(true)}>
                  <Fingerprint className="h-4 w-4 mr-2" />
                  Solicitar Firma
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setFirmaInternaDialogOpen(true)}>
                  <Fingerprint className="h-4 w-4 mr-2" />
                  Firmar Ahora
                </DropdownMenuItem>
                <DropdownMenuSeparator />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <FirmasDocumento
              ...
              documentoId={parte._id}
              codigoDocumento={parte.codigo || `PT-${parte._id.slice(-6)}`}
            />
      ...
      <FirmaInternaModal
        tipoDocumento="parteTrabajo"
        documentoId={parte._id}
        tipoFirmante="tecnico"
        open={firmaInternaDialogOpen}
        onClose={() => setFirmaInternaDialogOpen(false)}
      />
      </>
  )
}
