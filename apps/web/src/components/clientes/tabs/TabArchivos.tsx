...
export function TabArchivos({ clienteId, clienteNombre }: TabArchivosProps) {
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Documentos adjuntos relacionados con {clienteNombre}
            </CardDescription>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 border-2 border-dashed rounded-lg">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Aún no hay documentos adjuntos para este cliente
            </p>
