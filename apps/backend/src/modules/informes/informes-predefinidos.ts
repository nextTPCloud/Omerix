  ...
  return [
    ...
    },
    {
      ...
      campos: [
        ...
        { campo: 'tipo', etiqueta: 'Tipo', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 2 },
        { campo: 'documentoNumero', etiqueta: 'Documento', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 3 },
    ...
    // ============================================
    {
      nombre: 'Modelo 347 - Operaciones con Clientes',
      descripcion: 'Declaración anual de operaciones con terceros (clientes). La obligación de declarar aplica a operaciones que superen 3.005,06€ anuales por tercero. Filtre el resultado tras exportar.',
      modulo: ModuloInforme.CONTABILIDAD,
      tipo: TipoInforme.TABLA,
      icono: 'FileText',
      fuente: { coleccion: 'facturas' },
      campos: [
        { campo: 'clienteNif', etiqueta: 'NIF/CIF', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 1 },
        { campo: 'clienteNombre', etiqueta: 'Cliente', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 2 },
        { campo: 'totales.totalFactura', etiqueta: 'Total Operaciones', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 3 },
        { campo: '_id', etiqueta: 'Nº Facturas', tipo: TipoCampo.NUMERO, visible: true, agregacion: TipoAgregacion.CONTEO, orden: 4 },
      ],
      filtros: [
        { campo: 'activo', operador: OperadorFiltro.IGUAL, valor: true },
        { campo: 'estado', operador: OperadorFiltro.DIFERENTE, valor: 'anulada' },
      ],
      parametros: [
        { nombre: 'fechaDesde', etiqueta: 'Desde', tipo: 'fecha', requerido: true },
        { nombre: 'fechaHasta', etiqueta: 'Hasta', tipo: 'fecha', requerido: true },
      ],
      agrupaciones: [{ campo: 'clienteNif', orden: 'asc' }, { campo: 'clienteNombre', orden: 'asc' }],
      ordenamiento: [{ campo: 'totales.totalFactura', direccion: 'desc' }],
      config: { paginacion: true, mostrarTotales: true, exportable: true, formatos: ['excel', 'pdf', 'csv'] },
      esPlantilla: true,
      compartido: true,
    ...
    {
      nombre: 'Modelo 347 - Operaciones con Proveedores',
      descripcion: 'Declaración anual de operaciones con terceros (proveedores). La obligación de declarar aplica a operaciones que superen 3.005,06€ anuales por tercero. Filtre el resultado tras exportar.',
      modulo: ModuloInforme.CONTABILIDAD,
      tipo: TipoInforme.TABLA,
      icono: 'FileText',
      fuente: { coleccion: 'facturacompras' },
      campos: [
        { campo: 'proveedorNif', etiqueta: 'NIF/CIF', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 1 },
        { campo: 'proveedorNombre', etiqueta: 'Proveedor', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 2 },
        { campo: 'totales.totalFactura', etiqueta: 'Total Operaciones', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 3 },
        { campo: '_id', etiqueta: 'Nº Facturas', tipo: TipoCampo.NUMERO, visible: true, agregacion: TipoAgregacion.CONTEO, orden: 4 },
      ],
      filtros: [
      ...
      agrupaciones: [{ campo: 'proveedorNif', orden: 'asc' }, { campo: 'proveedorNombre', orden: 'asc' }],
      ordenamiento: [{ campo: 'totales.totalFactura', direccion: 'desc' }],
      config: { paginacion: true, mostrarTotales: true, exportable: true, formatos: ['excel', 'pdf', 'csv'] },
      esPlantilla: true,
      compartido: true,
    ...
    {
      nombre: 'Modelo 347 - Detalle Trimestral por Cliente',
      descripcion: 'Detalle trimestral de operaciones con clientes para la declaración 347. Seleccione las fechas del trimestre a consultar.',
      modulo: ModuloInforme.CONTABILIDAD,
      tipo: TipoInforme.TABLA,
      icono: 'Calendar',
      fuente: { coleccion: 'facturas' },
      campos: [
        ...
        { campo: 'totales.totalIva', etiqueta: 'IVA', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 4 },
        { campo: 'totales.totalFactura', etiqueta: 'Total', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 5 },
        { campo: '_id', etiqueta: 'Nº Facturas', tipo: TipoCampo.NUMERO, visible: true, agregacion: TipoAgregacion.CONTEO, orden: 6 },
      ],
      filtros: [
        { campo: 'activo', operador: OperadorFiltro.IGUAL, valor: true },
        { campo: 'estado', operador: OperadorFiltro.DIFERENTE, valor: 'anulada' },
    ...
    // --- Informes de morosidad (TESORERÍA) ---
    {
      nombre: 'Vencimientos Impagados',
      descripcion: 'Listado detallado de vencimientos en estado impagado o devuelto',
      modulo: ModuloInforme.TESORERIA,
      tipo: TipoInforme.TABLA,
      icono: 'AlertTriangle',
      fuente: { coleccion: 'vencimientos' },
      campos: [
        { campo: 'terceroNombre', etiqueta: 'Tercero', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 1 },
        { campo: 'terceroNif', etiqueta: 'NIF', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 2 },
        { campo: 'documentoNumero', etiqueta: 'Documento', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 3 },
        { campo: 'tipo', etiqueta: 'Tipo', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 4 },
        { campo: 'fechaVencimiento', etiqueta: 'Vencimiento', tipo: TipoCampo.FECHA, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 5 },
        { campo: 'importe', etiqueta: 'Importe', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 6 },
        { campo: 'importePendiente', etiqueta: 'Pendiente', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 7 },
        { campo: 'formaPago', etiqueta: 'Forma Pago', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 8 },
        { campo: 'estado', etiqueta: 'Estado', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 9 },
      ],
      filtros: [
        { campo: 'estado', operador: OperadorFiltro.EN, valor: ['impagado', 'devuelto'] },
      ],
      parametros: [
        { nombre: 'tipo', etiqueta: 'Tipo', tipo: 'select', requerido: false, opciones: [
          { valor: '', etiqueta: 'Todos' },
    ...
    {
      nombre: 'Morosidad por Tercero',
      descripcion: 'Resumen de deuda pendiente agrupada por tercero (solo cobros). Permite identificar los mayores deudores.',
      modulo: ModuloInforme.TESORERIA,
      tipo: TipoInforme.TABLA,
      icono: 'Users',
      fuente: { coleccion: 'vencimientos' },
      campos: [
        { campo: 'terceroNombre', etiqueta: 'Tercero', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 1 },
        { campo: 'terceroNif', etiqueta: 'NIF', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 2 },
        { campo: 'importePendiente', etiqueta: 'Total Pendiente', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 3 },
        { campo: 'importe', etiqueta: 'Importe Original', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 4 },
        { campo: '_id', etiqueta: 'Nº Vencimientos', tipo: TipoCampo.NUMERO, visible: true, agregacion: TipoAgregacion.CONTEO, orden: 5 },
      ],
      filtros: [
        { campo: 'estado', operador: OperadorFiltro.EN, valor: ['impagado', 'devuelto'] },
      ...
      parametros: [],
      agrupaciones: [{ campo: 'terceroNombre', orden: 'asc' }, { campo: 'terceroNif', orden: 'asc' }],
      ordenamiento: [{ campo: 'importePendiente', direccion: 'desc' }],
      config: { paginacion: true, mostrarTotales: true, exportable: true, formatos: ['excel', 'pdf'] },
      esPlantilla: true,
      compartido: true,
      orden: 4,
    ...
    {
      nombre: 'Antigüedad de Saldos Pendientes',
      descripcion: 'Listado de vencimientos pendientes de cobro ordenados por antigüedad. Permite analizar la edad de la deuda.',
      modulo: ModuloInforme.TESORERIA,
      tipo: TipoInforme.TABLA,
      icono: 'Clock',
      fuente: { coleccion: 'vencimientos' },
      campos: [
        ...
        { campo: 'terceroNif', etiqueta: 'NIF', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 2 },
        { campo: 'documentoNumero', etiqueta: 'Documento', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 3 },
        { campo: 'fechaEmision', etiqueta: 'Emisión', tipo: TipoCampo.FECHA, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 4 },
        { campo: 'fechaVencimiento', etiqueta: 'Vencimiento', tipo: TipoCampo.FECHA, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 5 },
        { campo: 'importe', etiqueta: 'Importe', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 6 },
        { campo: 'importePendiente', etiqueta: 'Pendiente', tipo: TipoCampo.MONEDA, visible: true, agregacion: TipoAgregacion.SUMA, orden: 7 },
        { campo: 'formaPago', etiqueta: 'Forma Pago', tipo: TipoCampo.TEXTO, visible: true, agregacion: TipoAgregacion.NINGUNA, orden: 8 },
      ...
      filtros: [
        { campo: 'estado', operador: OperadorFiltro.EN, valor: ['pendiente', 'parcial', 'impagado'] },
        { campo: 'tipo', operador: OperadorFiltro.IGUAL, valor: 'cobro' },
        { campo: 'importePendiente', operador: OperadorFiltro.MAYOR, valor: 0 },
      ],
      parametros: [
        { nombre: 'terceroNombre', etiqueta: 'Tercero', tipo: 'texto', requerido: false },
      ],
      agrupaciones: [],
      ordenamiento: [{ campo: 'fechaVencimiento', direccion: 'asc' }],
      config: { paginacion: true, mostrarTotales: true, exportable: true, formatos: ['excel', 'pdf', 'csv'] },
